...
export declare namespace dfareporting_v3_4 {
    ...
    export class Resource$Customevents {
         ...
         * @return {object} Request object
         */
        batchinsert(params?: Params$Resource$Customevents$Batchinsert, options?: MethodOptions): GaxiosPromise<Schema$CustomEventsBatchInsertResponse>;
        batchinsert(params: Params$Resource$Customevents$Batchinsert, options: MethodOptions | BodyResponseCallback<Schema$CustomEventsBatchInsertResponse>, callback: BodyResponseCallback<Schema$CustomEventsBatchInsertResponse>): void;
        batchinsert(params: Params$Resource$Customevents$Batchinsert, callback: BodyResponseCallback<Schema$CustomEventsBatchInsertResponse>): void;
        batchinsert(callback: BodyResponseCallback<Schema$CustomEventsBatchInsertResponse>): void;
    }
    export interface Params$Resource$Customevents$Batchinsert extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
